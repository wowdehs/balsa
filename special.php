        ...
        <div class="row">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-3">Boyoz</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-4">Domates kasarlı</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-5">Pizza</a>
              </li>
            </ul>
          </div>
